...
// ---------------------------------------------------------------------------
// Files outside the project fall back to the basename only: entries can be
// pushed to team sync, and a foreign absolute path would leak usernames and
// machine layout (same rule as graph.displayPath).
