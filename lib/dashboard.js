...
// The two nothing-states. Signed in but team-less: nudge toward a team (its own
// work would already be showing via local entries if there were any). Otherwise:
// the plain "nothing has synced yet" hint.
...
document.getElementById('view-home').addEventListener('click', function (e) {
  ...
  if (chip) {
    ...
    homeFp = ''; homeBefore = null; loadHome();
    return;
  }
