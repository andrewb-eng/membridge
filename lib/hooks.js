...
module.exports = {
  runStop, runAppend, countSummaryLines, hasSummaryLine, blockReason, summariesPath, claudeSettingsPath, SUMMARIES_FILE,
  setupHooks, removeHooks, isHookInstalled, hookCommand, appendAllowRule,
};
