...
function runPostCommit() {
  try {
    ...
    // sync loop never re-attributes recorded shas), so a commit this hook
    // cannot attribute is deferred to the daemon, whose capture runs after
    // events are merged and sees the fresh edits.
