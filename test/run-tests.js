...
async function main() {
  ...
  try {
    ...
    check('dashboard Settings screen renders without the BYOK/advisor-key UI', () => {
      ...
      // The BYOK advisor-key UI was removed from the dashboard (the /api/advisor
      // backend is retained and covered by the M2 tests below). The Settings
      // screen must no longer surface any key-entry affordance.
